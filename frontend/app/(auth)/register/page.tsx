    ...
    <div className="min-h-screen bg-[#4A90e2] relative flex items-center justify-center p-4 sm:p-6 overflow-hidden">
      ...
      <div className="w-full max-w-lg relative z-10 py-8">
        ...
        <div className="bg-white rounded-2xl p-6 sm:p-8 border border-slate-200/80 shadow-2xl shadow-slate-950/20">
          <div className="mb-6">
            <h1 className="text-xl sm:text-2xl font-bold text-slate-900 tracking-tight">Create your account</h1>
            <p className="text-slate-500 text-xs sm:text-sm mt-1">Start unifying your cards and smart routing in seconds</p>
          </div>
          ...
          <div className="mt-6 pt-5 border-t border-slate-100 flex items-center justify-between text-xs">
            ...
            <Link href="/login" className="text-slate-900 font-semibold hover:text-[#4A90e2] transition-colors">
              Sign in
            </Link>
          </div>
        </div>
